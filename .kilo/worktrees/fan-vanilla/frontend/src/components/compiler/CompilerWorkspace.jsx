...
const CompilerWorkspace = ({ problemId, problem }) => {
  ...
  const handleRun = async () => {
    ...
    if (!isAuthenticated) {
      setError("Please log in to run your code.");
      return;
    }
        ...
        <div className="editor-tab-content">
          <div className="compiler-header">
            ...
            <label className="compiler-language">
              <span>Language</span>
              <select value={language} onChange={handleLanguageChange} disabled={isRunning || isSubmitting || isGeneratingReview || !isAuthenticated}>
             ...
             <div className="monaco-editor-wrapper">
               <Editor
                 ...
                 options={{
                   ...
                   readOnly: !isAuthenticated || isRunning || isSubmitting || isGeneratingReview,
          ...
          <div className="editor-controls-pane">
            <label className="program-input-label">
              ...
              <textarea
                ...
                spellCheck="false"
                disabled={isRunning || isSubmitting || isGeneratingReview || !isAuthenticated}
              />
          </label>
          ...
          <div className="action-buttons-group">
            ...
            >
              <Play size={16} />
              {!isAuthenticated ? "Login to Run" : isRunning ? "Running..." : "Run Code"}
            </button>
            ...
            {isAuthenticated ? (
              ...
              <div className="auth-cta-group">
                ...
                <span className="auth-cta-text">
                  Please <Link to="/login">login</Link> to run, submit, or request AI review.
                </span>
              </div>
            )}
          </div>
